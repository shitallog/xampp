                    ...
                    <div class="card mini-stat bg-primary text-white">
                        <div class="card-body" style="padding: 10px;">
                            <div class="mb-4">
                                ...
                                <h5 class="font-size-16 text-uppercase text-white-50">Total Shipment</h5>
                    ...
                    <div class="card mini-stat bg-primary text-white">
                        <div class="card-body" style="padding: 10px;">
                            <div class="mb-4">
                                ...
                                <h5 class="font-size-16 text-uppercase text-white-50">Pending Pickup Request</h5>
                    ...
                    <div class="card mini-stat bg-primary text-white">
                        <div class="card-body" style="padding: 10px;">
                            <div class="mb-4">
                                ...
                                <h5 class="font-size-16 text-uppercase text-white-50">Deliverd Shipment</h5>
                    ...
                    <div class="card mini-stat bg-primary text-white">
                        <div class="card-body" style="padding: 10px;">
                            <div class="mb-4">
                                ...
                                <h5 class="font-size-16 text-uppercase text-white-50">Pending Shipment</h5>
                                <h4 class="fw-medium font-size-24">2436 </h4>
                    ...
                    <div class="card mini-stat bg-primary text-white">
                        <div class="card-body" style="padding: 10px;">
                            <div class="mb-4">
                                ...
                                <h5 class="font-size-16 text-uppercase text-white-50">Intransit Shipment</h5>
                                <h4 class="fw-medium font-size-24">2436 </h4>
