...
<body id="body">
  <div id="content">
    <div style="width: 700px;margin: 0 auto;  color: #33394D; font-style: normal; font-family: 'IBM Plex Sans'; padding: 5.5rem 0 0.5rem 0;margin-bottom:100px" id="wrapper"><div style="padding: 0 1.5rem;">
        <div style="font-weight: 400; font-size: 12px; line-height: 1.1rem; margin-bottom: 0.5rem;">
            <div style="font-weight: 700; font-size: 1rem; line-height: 1.5rem;">Tax Invoice  
            <button type="button" style="float: right;margin-left:20px" class="btn btn-danger waves-effect waves-light">Cancel Order</button>
            @if(empty($client_order->awb_no))
                <button type="button" style="float: right;" class="btn btn-success waves-effect waves-light">GET AWB NO</button>
            @endif
            </div>
            ...
            <tbody>
                <tr style="border-bottom: 1px #E0E3EB solid; vertical-align: top;">
                    <td style="padding-bottom: 1rem; width: 50%">
                        <div style="font-weight: 400; font-size: 12px; line-height: 1.1rem;">
                ...
                <tr style="vertical-align: top;">
                    <td style="padding: 1rem 0;">
                        <div style="font-weight: 600; font-size: 12px; line-height: 1.1rem;">
    ...
    <table style="font-weight: 400; font-size: 12px; line-height: 1.1rem; border-collapse: collapse; width: 100%;">
    ...
    <div style="text-align: center; font-weight: 600; font-size: 12px; line-height: 1.1rem;">Powered by QuickWay</div>
</div>
</div>
